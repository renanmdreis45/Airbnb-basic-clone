# Airbnb experience clone básico
 
<p align="center"> 
<img src="https://github.com/renanmdreis45/Airbnb-basic-clone/blob/master/public/images/airbnb-logo.jpg" alt="App orçamento pessoal" width="200" height="63px">
</p>
...
<p>
Clone básico da interface do airbnb, só que ao invés de aluguéis, são disponibilizados serviços.
</p>

<p>
Nesse projeto o conceito de props para a reutilização de um mesmo componente (card) foi bastante enfatizado. Além disso, os cards foram inseridos dentro de uma lista, onde há o retorno de cada um pelo método arr.map() e suas propriedades são acessadas através do operador spread.
</p>
<p> O foco do projeto são os pontos ressaltados acima, portanto, há somente três serviços, algumas característica essenciais deles e a disponibilidade de cada um </p>
...
<a href="https://www.figma.com/file/tul9kN5fH7I7eS4mDS4JkI/Arirbnb-clone?node-id=0%3A1" rel="nofollow">
...
<p align="center"> 
<a href="https://ibb.co/C6k99Wd"><img src="https://i.ibb.co/r3CppvP/airbnb-basic.png" alt="airbnb-basic" border="0"></a>
</p>
...
<p> Para executar o projeto basta clonar o repositório executando no terminal:
 <code> git clone https://github.com/renanmdreis45/Airbnb-basic-clone </code>
</p>
<p>
